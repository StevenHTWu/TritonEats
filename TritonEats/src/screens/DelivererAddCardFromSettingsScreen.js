...
class DelivererAddCardFromSettingsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
DelivererAddCardFromSettingsScreen.navigationOptions = () => {
  return {
    header: () => false,
  };
};
...
export default DelivererAddCardFromSettingsScreen;
