...
class AddCardScreen extends Component {//= ({ navigation }, props) => {
  /*
      ...
      <View style={styles.container}>
        ...
        />
          ...
          <View style={styles.layer2}>
            <TouchableOpacity
                onPress={() => this.props.navigation.navigate("PaymentScreen", {cardNum:this.state.cardNum, date:this.state.date, cvv:this.state.cvv, name:this.state.name})}
