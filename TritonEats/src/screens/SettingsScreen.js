...
let object2 = {
  profile: { name: "mudit", email: "example@ucsd.edu", phone: "1234567890" },
  payment: { card_number: "1234567890123456", expiry: "0922", cvv: "123" },
  address: {
    apartment_number: "212",
    building: "Earth Hall North",
    line: "Address",
  },
  password: "1234",
  password1: "",
...
class DropdownList extends Component {
  ...
  _keyboardDidShow = (e) => {
    this.setState({
      scrollHeight:
        Dimensions.get("window").height * 0.815 - e.endCoordinates.height,
    });
  };
  _keyboardDidHide = () => {
    this.setState({
  ...
  render() {
    return (
      <SafeAreaView>
        <ScrollView
          style={{ marginVertical: 20, height: this.state.scrollHeight }}
        >
          <Text style={styles.text} onPress={this.profile}>
            My Profile
          </Text>
          ...
          <View style={{ height: this.state.profileHeight }}>
            ...
            <TextInput
              ...
              onChangeText={(text) => (object.email = text)}
            />
          </View>
          <View style={{ height: this.state.profileHeight }}>
            ...
            <TextInput
              ...
              maxLength={ten}
              onChangeText={(text) => (object.phone_num = text)}
            />
          </View>
          <View style={{ height: this.state.profileButtonHeight }}>
            <Text style={styles.button} onPress={this.saveProfile}>
              Save
            </Text>
          </View>

          <Text style={styles.text} onPress={this.payment}>
            Add Payment Method
          </Text>
          ...
          <View style={{ height: this.state.paymentButtonHeight }}>
            <Text style={styles.button} onPress={this.savePayment}>
              Save
            </Text>
          </View>

          <Text style={styles.text} onPress={this.address}>
            Manage Address
          </Text>
          ...
          <View style={{ height: this.state.addressButtonHeight }}>
            <Text style={styles.button} onPress={this.saveAddress}>
              Save
            </Text>
          </View>

          <Text style={styles.text} onPress={this.password}>
            Change Password
          </Text>
          ...
          <View style={{ height: this.state.passwordButtonHeight }}>
            <Text style={styles.button} onPress={this.savePassword}>
              Save
            </Text>
          </View>
